                        ...
                        <div className="position-relative overflow-hidden">
                            ...
                            <ul className="list-inline p-3 mb-0 team-social-item">
                                <li className="list-inline-item mx-3">
                                    <a href="#" className="team-social-icon h-primary"><Facebook className="icon-sm" /></a>
                                </li>
                                
                                <li className="list-inline-item mx-3">
                                    <a href="#" className="team-social-icon h-danger"><Instagram className="icon-sm" /></a>
                                </li>
                                <li className="list-inline-item mx-3">
                                    <a href="#" className="team-social-icon h-info"><Twitter className="icon-sm"/></a>
                                </li>
                                <li className="list-inline-item mx-3">
                                    <a href="#" className="team-social-icon h-warning"><Linkedin className="icon-sm" /></a>
                                </li>
                            </ul>
                        </div>
                        <div className="p-4">
